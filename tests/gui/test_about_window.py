...
def _build_window(app_name="Test App", version="1.0"):
    ...
    with (
        ...
        patch("fishbowl_common.gui.about_window.tk.Label", side_effect=_distinct_widget) as label_cls,
        patch("fishbowl_common.gui.about_window.tk.Button", side_effect=_distinct_widget) as button_cls,
    ):
        window = AboutWindow(
            parent=MagicMock(),
            title="About",
